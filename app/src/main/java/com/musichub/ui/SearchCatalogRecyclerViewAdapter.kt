...
class SearchCatalogRecyclerViewAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (holder.itemViewType) {
            0 -> (holder as SearchDatabaseArtistItem).setData(
                entityList[position] as AppleMusicArtist,
                showType
            )
            1 -> (holder as SearchDatabaseAlbumItem).setData(
                entityList[position] as AppleMusicAlbum,
                showType
            )
            2 -> (holder as SearchDatabaseTrackItem).setData(
                entityList[position] as AppleMusicSong,
                showType
            )
            3 -> (holder as SearchDatabaseTrackItem).setData(
                entityList[position] as AppleMusicMV,
                showType
            )
    ...
    private inner class SearchDatabaseArtistItem(itemView: View) :
        RecyclerView.ViewHolder(itemView) {
        private val titleTextView: TextView =
            itemView.findViewById(R.id.item_search_catalog_artist_tv_title)
        private val labelTextView: TextView =
            itemView.findViewById(R.id.item_search_catalog_artist_tv_label)
    ...
    private inner class SearchDatabaseAlbumItem(itemView: View) :
        RecyclerView.ViewHolder(itemView) {
        private val coverartImageView: ImageView =
            itemView.findViewById(R.id.item_catalog_album_iv_coverart)
        private val titleTextView: TextView =
            itemView.findViewById(R.id.item_catalog_album_tv_title)
        private val labelTextView: TextView =
            itemView.findViewById(R.id.item_catalog_album_tv_label)
    ...
    private inner class SearchDatabaseTrackItem(itemView: View) :
        RecyclerView.ViewHolder(itemView) {
        private val coverartImageView: ImageView =
            itemView.findViewById(R.id.item_search_catalog_track_iv_coverart)
        private val titleTextView: TextView =
            itemView.findViewById(R.id.item_search_catalog_track_tv_title)
        private val labelTextView: TextView =
            itemView.findViewById(R.id.item_search_catalog_track_tv_label)
    ...
    private inner class SearchDatabaseViewallItem(itemView: View) :
        RecyclerView.ViewHolder(itemView) {
        private val titleTextView: TextView =
            itemView.findViewById(R.id.item_search_catalog_viewall_tv_title)
